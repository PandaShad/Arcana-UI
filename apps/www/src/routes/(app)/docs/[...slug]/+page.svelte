<script lang="ts">
	...
	import DocsToc from '@/components/docs-toc.svelte';
	import Metadata from '@/components/metadata.svelte';
	import { Badge } from '@/components/ui/badge/index.js';
	import { Button } from '@/components/ui/button/index.js';
	import { findNeighbors } from '@/utils/navigation.js';
	import {
		ArrowLeftIcon,
		ArrowRightIcon,
		ExternalLinkIcon
	...
	console.log(`Rendering page for document: ${doc.title}`, doc);
			...
			<div class="flex flex-col gap-2">
				<div class="flex flex-col gap-2">
					...
					{#if data.metadata.description}
						<p
							class="text-muted-foreground text-balance text-[1.05rem] sm:text-base"
						>
							{doc.description}
						</p>
					{/if}
