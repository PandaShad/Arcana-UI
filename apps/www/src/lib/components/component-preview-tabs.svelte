<script lang="ts">
	...
	console.log('component-preview props', {
		className,
		align,
		hideCode,
		component,
...
<div
	class={cn('group relative mb-12 mt-4 flex flex-col gap-2', className)}
	{...restProps}
>
	<Tabs class="relative mr-auto w-full" bind:value>
		<div class="flex items-center justify-between" data-llm-ignore>
			{#if !hideCode}
				<TabsList
					class="justify-start gap-4 rounded-none bg-transparent px-2 md:px-0"
				>
					<TabsTrigger
						value="preview"
